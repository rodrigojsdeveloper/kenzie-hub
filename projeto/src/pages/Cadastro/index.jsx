    ...
    return (
        <Container>
            ...
            <div className="divLogo">
                ...
                <Button border={ false } botaoTam="voltar" onClick={ () => history.push("/") } >Voltar</Button>
            </div>
            ...
            <Content>
                <form onSubmit={ handleSubmit(onSubmitFunction) }>
                    ...
                    <Button type="submit" botaoTam="cadastro" disabled={ load } >{ load ? "Cadastrando..." : "Cadastrar" }</Button>
                </form>
            </Content>
        </Container>
    )
