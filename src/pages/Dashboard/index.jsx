...
const Dashboard = ({ setUser, setAutenticacao, cards, setCards, user }) => {
  ...
  return (
    <Container>
      ...
      {
        abrirEditarModal && <ModalEditarCard 
      ...
      <header>
        ...
        <Button botaoTam="sair" border={ false } onClick={ handleClick }>Sair</Button>
      </header>
      ...
      <div className="divTecnologias">
        ...
        <Button botaoTam="mais" border={ false } onClick={ () => setAbrirModal(true) } >+</Button>
      </div>
      
      <div className='divContainerCard'>
        <div className='divContentCard'>
          {
            cards.map(card => <Card key={ card.id } card={ card } setAbrirEditarModal={ setAbrirEditarModal } setTecnologiaAtual={ setTecnologiaAtual } />)
          }
        </div>
      </div>
    </Container>
